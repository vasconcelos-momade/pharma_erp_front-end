...
const List<AppNavItem> kAppNavItems = <AppNavItem>[
  ...
  AppNavItem(label: 'Transferências', path: AppRoutePaths.stockTransfers, icon: Icons.local_shipping_outlined),
  AppNavItem(label: 'Ajustes', path: AppRoutePaths.stockAdjustments, icon: Icons.tune),
  AppNavItem(label: 'Inventário', path: AppRoutePaths.stockInventory, icon: Icons.fact_check_outlined),
  AppNavItem(label: 'Compras', path: AppRoutePaths.purchasing, icon: Icons.shopping_cart_outlined),
