...
Map<String, dynamic> regulatoryReportQuery(Map<String, dynamic> params) {
...
List<Widget> regulatoryReportActions({
  ...
  final query = regulatoryReportQuery(queryParameters);
...
Widget? regulatoryReportError(WidgetRef ref) {
